...
contract Invariant is StdInvariant, Test {
    ...
    function setUp() public {
        ...
        selectors[1] = handler.swapWethBasedOnOutputWeth.selector;
    ...
    function statefulFuzz_constantProductFormulaStaysTheSameX() public {
        assertEq(handler.expected_delta_x(), handler.actual_delta_x());
    }

    function statefulFuzz_constantProductFormulaStaysTheSameY() public {
        assertEq(handler.expected_delta_y(), handler.actual_delta_y());
    }
}
